...
+(BOOL)detectCustomFontsShowingAlert:(BOOL)showAlert
{
    ...
    NSString *message = [NSString stringWithFormat:@"CustomFont changes detected!\nAdded: %@\nRemoved: %@\nNew m/h files have been generated to your log.", (addedSelectorNames.count) ? [addedSelectorNames componentsJoinedByString:@", "] : @"(none)", (removedSelectorNames.count) ? [removedSelectorNames componentsJoinedByString:@", "] : @"(none)"];
